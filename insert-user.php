...
$query="INSERT into employee (name,father_name,mother_name,dob,doj,department,blood_group,gender,religion,
		marital_status,permanent_address,present_address,contactno,email,password,confirmpassword) values ('$name',
		'$fname','$mname','$dob','$doj','$depart','$blood_group','$gender','$religion','$marital_status','$permaddress',
