...
<body>
<div class="display-4 text-primary text-uppercase"><strong><center>Employee Registration Form</center></strong></div>
<div class="container bg-gray">

  <form class="form-horizontal" method="post" action= "" onsubmit=" return formValidation();">
    ...
    <div class="form-group">
      <strong>Department:</strong>
       <input type="radio" id="depart" name="depart" value="Web Technology">
        ...
        <input type="radio" id="depart" name="depart" onclick="showText(this.value)" value="other">
        <strong for="other">Other</strong>
        <input id="depart" type="text" style="display:none;"> 
      </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
...
<div class="row">
  <div class="col-md-6">
    ...
    <textarea name="presentaddress" maxlength="1000" cols="70" rows="10"></textarea>
  </div> 
  <div class="col-md-6">
    <strong for="permAddress">Permanent Address:</strong><br>
    <textarea name="permaddress" maxlength="1000" cols="65" rows="10"></textarea>
  </div>      
</div>
<div class="row">
  <div class="col">
